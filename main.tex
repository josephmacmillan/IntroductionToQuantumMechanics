...
\part{Quantum Mechanics in Zero Dimensions}
\include{1_stern_gerlach_experiments}
\include{2_the_quantum_state_vector}
\include{3_amplitude_and_probability}
\include{4_observables_and_operators}
\include{5_measurement_and_uncertainty}
\include{6_schrodinger_equation}
\include{7_examples_of_discrete_systems}
\part{Quantum Mechanics in One Dimension}
\include{8_the_wave_function}
\include{9_the_infinite_square_well}
\include{10_finite_square_well}
\part{Quantum Mechanics in Higher Dimensions}
