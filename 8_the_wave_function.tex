...
Take a look at Figure \ref{fig_potential_energy_example}, which shows a generic potential energy.  If a particle has a total energy $E$ -- which will always be constant -- as shown in red, then classically the particle is \emph{bound} between the turning points at $x_1$ and $x_2$.  The region outside the turning points is often called the \emph{classical forbidden region}, and although in classical physics the particle will never been found outside the well, in quantum mechanics it is possible to \emph{tunnel} through the barrier and escape, as we'll see later.  
