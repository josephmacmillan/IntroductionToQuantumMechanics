...
\[
\hat{x}, \quad \hat{y}, \quad \text{and} \quad \hat{z}
\]
...
\[
\braket{\psi}{\phi} \to \begin{pmatrix} 1/\sqrt{5} & -2i/\sqrt{5} \end{pmatrix} \begin{pmatrix} 3/5 \\ 4/ 5 \end{pmatrix} = \frac{3}{5\sqrt{5}} + \frac{8i}{5\sqrt{5}}.
\]
