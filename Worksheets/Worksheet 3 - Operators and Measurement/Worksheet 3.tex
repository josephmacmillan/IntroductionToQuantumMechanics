...
\begin{enumerate}
\item Consider a \emph{quantum mouse} -- this is like a normal mouse but its properties behave in a quantum way.\footnote{This idea was borrowed from the tutorials produced at the University of Colorado Boulder.}   There are lots of things we can observe about the mouse, like its colour, or tail length, or eye size, or mood, although for this worksheet we'll stick to making measurements of the mouse's
\begin{itemize}
